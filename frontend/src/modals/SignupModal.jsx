...
export const SignupModal = () => {
  ...
  e.preventDefault();
  console.log("📩 Signup button clicked with:", signupDetails);
  ...
  if (
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        signupSuccessToast(response.data.message || "Registration successful!");
      }
    } catch (err) {
      console.log("Error during registration:", err);
      dispatch(hideSignModal());
      signupFailedToast(err?.response?.data?.message || "Registration failed");
    } finally {
      setLoading(false);
    }
  } else {
    signupFailedToast("Please fill all required fields correctly.");
  }
};
    ...
    <div className="signup-form">
      <form onSubmit={(e) => handleDataInsert(e)}>
        ...
        <div className="signup-form-body">
          ...
          <div className="signup-form-category">
            <label>
              Phone Number(Must contain 10 digits): <span>*</span>
            </label>
            <input
              disabled={loading}
              name="phoneNumber"
