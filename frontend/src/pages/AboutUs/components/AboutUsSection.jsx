      ...
      <div className="container">
        <div className="about-us-heading">
          ...
          <div className="aboutus-logo-container">
            ...
            <h1 className="aboutus-logo-text">QuickShow</h1>
          </div>
        </div>
        <div className="about-us-body">
          <p>Welcome to QuickShow,</p>
          <p>
            At QuickShow, we are passionate about delivering the ultimate
          ...
          <p>
            Join us at QuickShow and immerse yourself in the captivating world
